      ...
      <div className="grid md:grid-cols-2 gap-12 items-center">
        <div className="space-y-6">
          ...
          <p className="text-white/80 text-lg leading-relaxed">
            Started coding at 14 with a simple "Hello World" that sparked an obsession. Fast-forward to today, I'm a frontend developer who believes great design and clean code can change the world, one pixel at a time.
          </p>
          <p className="text-white/80 text-lg leading-relaxed">
          ...
          <div className="bg-white/5 backdrop-blur-xl rounded-2xl p-8 border border-white/10">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-white font-semibold">CSS Wizardry 🧪</span>
              </div>
            </div>
          </div>
        </div>
